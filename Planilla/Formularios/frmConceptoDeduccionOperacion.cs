...
{
    public partial class frmConceptoDeduccionOperacion : Form
    {
        public frmConceptoDeduccionOperacion()
        {
            InitializeComponent();
        }
        ...
        private void frmConceptoDeduccionOperacion_Shown(object sender, EventArgs e)
        {
        ...
        private void LlenarCamposDesdeBaseDatosSegunID()
        {
            ...
            ConceptoDeDeduccionEN oRegistrosEN = new ConceptoDeDeduccionEN();
            ConceptoDeDeduccionesLN oRegistrosLN = new ConceptoDeDeduccionesLN();

            oRegistrosEN.IdConceptoDeDeduccion = ValorLlavePrimariaEntidad;
            ...
            if (oRegistrosLN.ListadoPorID(oRegistrosEN, Program.oDatosDeConexioEN))
            {
                if (oRegistrosLN.TraerDatos().Rows.Count > 0)
                {
                    ...
                    txtConcepto.Text = Fila["ConceptoDeDeduccion"].ToString();
        ...
        private bool LosDatosIngresadosSonCorrectos()
        {
            ...
            {
                EP.SetError(txtConcepto, "Este campo no puede quedar vacío");
                txtConcepto.Focus();
                return false;
            }
        ...
        private ConceptoDeDeduccionEN InformacionDelRegistro()
        {

            ConceptoDeDeduccionEN oRegistroEN = new ConceptoDeDeduccionEN();

            oRegistroEN.IdConceptoDeDeduccion = Convert.ToInt32((txtIdentificador.Text.Length > 0 ? txtIdentificador.Text : "0"));
            oRegistroEN.ConceptoDeDeduccion = txtConcepto.Text;
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LosDatosIngresadosSonCorrectos())
                {
                    ...
                    ConceptoDeDeduccionEN oRegistroEN = InformacionDelRegistro();
                    ConceptoDeDeduccionesLN oRegistroLN = new ConceptoDeDeduccionesLN();
                    ...
                    if (oRegistroLN.Agregar(oRegistroEN, Program.oDatosDeConexioEN))
                    {
                        ...
                        txtIdentificador.Text = oRegistroEN.IdConceptoDeDeduccion.ToString();
                        ValorLlavePrimariaEntidad = oRegistroEN.IdConceptoDeDeduccion;
        ...
        private void frmConceptoDeduccionOperacion_FormClosing(object sender, FormClosingEventArgs e)
        {
