...
namespace Planilla.Formularios
{
    public partial class frmFaltas : Form
    {
        ...
        public FaltasEN[] oFaltas = new FaltasEN[0];
        ...
        private string WhereDinamico()
        {
            ...
            {
                Where += string.Format(" and IdFaltas like '%{0}%' ", txtIdentificador.Text.Trim());
            }
        ...
        private void FormatearDGV()
        {
            try
            {
                ...
                string OcultarColumnas = "IdFaltas, IdEmpleado";
                ...
                foreach (DataGridViewColumn c1 in dgvLista.Columns)
                {
                    if (c1.Visible == true)
                    {
                        if (c1.Name.Trim().ToUpper() != "Seleccionar".ToUpper())
                        {
                            ...
                            {
                                oFormato = new FormatoDGV(c1.Name.Trim(), "Fecha");
                            }
                            if (oFormato != null)
                            {
